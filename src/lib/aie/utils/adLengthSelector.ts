...
export class AdLengthSelector {
    ...
    private applyDefaults(input: Partial<AdLengthInput>): AdLengthInput {
        ...
        return {
            ...
            audience_temperature: input.audience_temperature || this.rules.defaults.audience_temperature,
            price: input.price,
            product_complexity: input.product_complexity || this.rules.defaults.product_complexity,
            has_strong_story: input.has_strong_story ?? this.rules.defaults.has_strong_story,
            is_premium_brand: input.is_premium_brand ?? this.rules.defaults.is_premium_brand
        };
    }
    ...
    private determineWinner(
        ...
        const preferenceOrder = audienceTemp === 'COLD'
