...
export class ContentExtractionAgent {
  ...
  private async extractFromAudio(file: File): Promise<ContentExtractionResult> {
    ...
    try {
      ...
      logger.error('[ContentExtractionAgent] Audio transcription failed:', error as Error, { component: 'content-extraction' });
      throw new Error(
  ...
  private async extractFromPDF(file: File): Promise<ContentExtractionResult> {
    ...
    try {
      ...
      logger.error('[ContentExtractionAgent] PDF extraction failed:', error as Error, { component: 'content-extraction' });
      throw new Error(
   ...
   */
  private async extractFromTextFile(file: File): Promise<ContentExtractionResult> {
    ...
    try {
      ...
      logger.error('[ContentExtractionAgent] Text file reading failed:', error as Error, { component: 'content-extraction' });
      throw new Error(
  ...
  private async extractFromImage(file: File): Promise<ContentExtractionResult> {
    ...
    try {
      ...
      logger.error('[ContentExtractionAgent] Image extraction failed:', error as Error, { component: 'content-extraction' });
      throw new Error(
  ...
  private async extractFromURL(url: string): Promise<ContentExtractionResult> {
    ...
    try {
      ...
      logger.error('[ContentExtractionAgent] URL extraction failed:', error as Error, { component: 'content-extraction' });
      throw new Error(
