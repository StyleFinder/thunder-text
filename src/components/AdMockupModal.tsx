    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: "13px", color: "#65676b" }}>Sponsored</div>
        </div>
      ...
      >
        ...
        >
          {productData?.vendor?.toLowerCase().replace(/\s/g, "") || "yourstore"}
          .com
        </div>
        <div
          style={{
        ...
        <div style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
            ...
            >
              ...
              <span>·</span>
              <span>
                {productData?.vendor?.toLowerCase().replace(/\s/g, "") ||
                  "yourstore"}
                .com
              </span>
            </div>
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: "14px", opacity: 0.8 }}>Sponsored</div>
          </div>
          <div
            style={{
              marginLeft: "auto",
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-gray-100 p-6 rounded-lg">{renderMockup()}</div>
