...
// Optimized for 85%+ profit margin based on AI costs:
...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    monthlyPrice: 34,
    annualPrice: 340,
    credits: "3,000 Product Descriptions",
    bulkGeneration: "400 Ads & Social Posts • 200 AI Images",
    highlighted: true,
    badge: "Most Popular",
    features: [
      ...
      { icon: Video, text: "Priority Support", included: true },
    ],
  },
];
