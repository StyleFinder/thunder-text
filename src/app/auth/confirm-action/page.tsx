...
const actionDetails: Record<ActionType, ActionInfo> = {
  account_deletion: {
    ...
    warningMessage:
      "This action cannot be undone. All your data, including generated content, settings, and integrations will be permanently removed.",
  ...
  email_change: {
    ...
    warningMessage:
      "After confirming, you will need to use your new email address to log in.",
  ...
  password_change: {
    ...
    warningMessage:
      "This will update your password immediately. You may need to log in again on other devices.",
  ...
  disconnect_integration: {
    ...
    warningMessage:
      "This will revoke access and remove all associated data. You can reconnect later if needed.",
          ...
          {success && actionInfo ? (
            ...
            <div className="text-center">
              ...
              <p className="text-gray-500 mb-6">
                {error ||
                  "This confirmation link has expired or is invalid. Please try the action again from your dashboard."}
              </p>
              <Button
            ...
            <>
              ...
              >
                <div className="flex items-start gap-3">
                  <ShieldAlert
                    ...
                    style={{
                      color: actionInfo.isDangerous ? "#dc2626" : "#6b7280",
                    }}
                  />
                  <p
                    className="text-sm"
              ...
              {metadata && Object.keys(metadata).length > 0 && (
                <div className="p-4 bg-gray-50 rounded-xl mb-6">
                  ...
                  {actionType === "disconnect_integration" &&
            ...
            <div className="text-center">
              ...
              <p className="text-gray-500 mb-6">
                We couldn't recognize the requested action. Please try again
                from your dashboard.
              </p>
              <Button
                className="w-full h-11 text-base font-medium"
