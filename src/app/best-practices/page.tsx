...
export default function BestPracticesPage() {
  ...
  const loadPractices = async () => {
    try {
      ...
      logger.error("Error loading best practices:", err as Error, {
        component: "best-practices",
      });
      setError(
        err instanceof Error ? err.message : "Failed to load best practices",
      );
    } finally {
      setLoading(false);
    }
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      logger.error("Error deleting:", err as Error, {
        component: "best-practices",
      });
          ...
          <div className="w-full">
            <div className="flex items-center justify-between">
              <div>
                ...
                >
                  AI-powered knowledge base for advertising insights
                </p>
              </div>
              <Button
                onClick={() => setUploadModalActive(true)}
                style={{
                  background: "#0066cc",
                  color: "#ffffff",
                  borderRadius: "8px",
              ...
              <div className="space-y-6">
                ...
                {loading ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-16 text-center">
                    <div className="w-64 h-64 mb-6 opacity-50 relative">
                      <Image
                  ...
                  <div>
                    ...
                    >
                      Showing {filteredPractices.length} of {practices.length}{" "}
                      resources
                    </p>
                    <div
                      style={{
                        ...
                        <TableBody>
                          {filteredPractices.map((practice) => (
                            <TableRow key={practice.id}>
                              ...
                              >
                                {formatDate(practice.uploaded_at)}
                              </TableCell>
                              <TableCell>
                                <Button
                                  size="sm"
          ...
          >
            ...
            {!processingResult ? (
                  ...
                  <TabsContent value="file" className="mt-4">
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          Supported: Audio (MP3, WAV, M4A), Documents (PDF, TXT,
                          MD), Images (JPEG, PNG, WebP)
                        </p>
                      </CardContent>
                    </Card>
                  </TabsContent>
                ...
                >
                  ...
                  >
                    <CardHeader style={{ padding: "24px" }}>
                      ...
                      >
                        AI will auto-detect if not provided
                      </CardDescription>
                    </CardHeader>
                    <CardContent
                      className="space-y-4"
                    ...
                    >
                        ...
                        <div>
                          ...
                          >
                            ...
                            >
                              ...
                              {PLATFORMS.filter((p) => p.value !== "").map(
                                (platform) => (
                                  <SelectItem
                                    key={platform.value}
                                    value={platform.value}
                      ...
                      <div>
                        ...
                        >
                          Source Name (e.g., Boutique Hub, Meta Blueprint)
                        </Label>
                        <Input
                          id="source"
              ...
              <div className="space-y-6">
                {processingResult.success ? (
                  <Alert className="border-green-200 bg-green-50">
                    ...
                    <AlertDescription className="text-green-700">
                      Your best practice has been analyzed and added to the
                      knowledge base.
                    </AlertDescription>
                  </Alert>
                ) : (
                  <Alert variant="destructive">
                    ...
                    <AlertDescription>
                      {processingResult.errors?.join(", ") ||
                        "Quality score too low or other issues detected"}
                    </AlertDescription>
                  </Alert>
                )}
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="text-oxford-900">
                      {processingResult.metadata.title}
                    </CardTitle>
                    <div className="flex gap-2 mt-2">
                      <Badge
                        variant="outline"
                        className="border-dodger-500 text-dodger-700"
                      >
                        {processingResult.metadata.platform}
                      </Badge>
                      <Badge variant="secondary">
                        {processingResult.metadata.category}
                      </Badge>
                      <Badge variant="secondary">
                        {processingResult.metadata.goal}
                      </Badge>
                    </div>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <p className="text-gray-700">
                      {processingResult.metadata.description}
                    </p>
                    ...
                    <div className="border-t pt-4">
                      <div className="flex gap-8">
                        <div>
                          ...
                          <Badge
                            variant={getQualityBadgeVariant(
                              processingResult.metadata.quality_score,
                            )}
                            className="text-base"
                          >
                            {processingResult.metadata.quality_score.toFixed(1)}
                            /10
                          </Badge>
                        </div>
                        <div>
                          ...
                          <Badge
                            variant="outline"
                            className="text-base border-dodger-500 text-dodger-700"
                          >
                    ...
                    {processingResult.metadata.extracted_insights.length >
                      0 && (
                      <div className="border-t pt-4">
                        ...
                        <ul className="list-disc list-inside space-y-2">
                          {processingResult.metadata.extracted_insights.map(
                            (insight, i) => (
                    ...
                    {processingResult.metadata.tags.length > 0 && (
                      <div className="border-t pt-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {processingResult.metadata.tags
                            .slice(0, 10)
                            .map((tag, i) => (
                    ...
                    {processingResult.metadata.example_quotes &&
                      processingResult.metadata.example_quotes.length > 0 && (
                        <div className="border-t pt-4">
                          <h3 className="font-semibold text-oxford-900 mb-3">
                            Example Quotes
                          </h3>
                          <div className="space-y-3">
                            {processingResult.metadata.example_quotes.map(
                              (quote, i) => (
                                <div
                                  key={i}
