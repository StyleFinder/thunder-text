...
/**
 * /stores/[shopId]/create-pd
 *
 * Create product description page using UUID-based routing.
...
import CreateProductPage from "@/app/create-pd/page";
...
export default function StoreCreatePdPage() {
  return (
