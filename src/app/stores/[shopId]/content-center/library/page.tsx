...
export default function LibraryPage() {
  ...
  const getGenerateUrl = () => shopId ? `/stores/${shopId}/content-center/generate` : '/content-center/generate';
  const getLibraryItemUrl = (id: string) => shopId ? `/stores/${shopId}/content-center/library/${id}` : `/content-center/library/${id}`;
  const getLibraryItemEditUrl = (id: string) => shopId ? `/stores/${shopId}/content-center/library/${id}/edit` : `/content-center/library/${id}/edit`;
  ...
  }, [selectedType, showSavedOnly, sortField, sortOrder, shop]);
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-3" style={{ marginBottom: '8px' }}>
                      <div className="flex-1 min-w-0">
                        <Link href={getLibraryItemUrl(item.id)}>
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <Link href={getLibraryItemEditUrl(item.id)}>
                            <DropdownMenuItem>
