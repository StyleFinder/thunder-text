...
export default function AdEditorPage() {
  ...
  // Build library URL based on routing context
  const getLibraryUrl = () => {
    if (shopId) {
      return `/stores/${shopId}/ads-library`;
    }
    return `/ads-library${shop ? `?shop=${encodeURIComponent(shop)}` : ""}`;
  };
  ...
  const handlePostToCampaign = async () => {
    if (!ad || !selectedCampaign || !selectedAdAccount || !shop) {
            ...
            <div className="text-center">
              ...
              <div className="space-y-3">
                ...
                <Button
                  ...
                  onClick={() => router.push(getLibraryUrl())}
                >
