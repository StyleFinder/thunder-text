        ...
        <div>
          ...
          <div style={{
            ...
            <div style={{ marginBottom: '1rem' }}>
              ...
              <p style={{ color: '#6b7280', fontSize: '0.9rem', margin: 0 }}>
                Create and manage size sets for your products (e.g., S/M/L, XS-XXL, numeric sizes)
              </p>
            </div>

            <Link href={`/settings/sizing?shop=${shop}`}>
              <button style={{
                backgroundColor: '#3b82f6',
                color: 'white',
                border: 'none',
            ...
            <div style={{
              ...
              <div style={{ fontSize: '0.85rem', color: '#475569' }}>
                ...
                <div style={{ marginTop: '0.25rem' }}>
                  • Size Sets: <span style={{ color: '#3b82f6', fontWeight: '500' }}>Loading...</span>
                </div>
              </div>
            </div>
          </div>
