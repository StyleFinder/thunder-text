...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Thunder Text - AI Product Description Generator for Shopify",
};
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700">
                Thunder Text ("we," "our," or "us") is committed to protecting
                your privacy. This Privacy Policy explains how we collect, use,
                disclose, and safeguard your information when you use our
                Shopify application and Facebook integration features.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ol className="list-decimal pl-6 text-gray-700 space-y-2">
                <li>
                  <strong>Service Delivery:</strong> Generate AI-powered product
                  descriptions and manage Facebook ad campaigns
                </li>
                <li>
                  <strong>Integration Management:</strong> Maintain connections
                  with Shopify and Facebook/Meta platforms
                </li>
                <li>
                  <strong>Analytics:</strong> Track usage, improve AI models,
                  and provide insights
                </li>
                <li>
                  <strong>Support:</strong> Respond to inquiries and
                  troubleshoot issues
                </li>
                <li>
            ...
            <section className="mb-8">
              ...
              <ol className="list-decimal pl-6 text-gray-700 space-y-2">
                <li>
                  <strong>OpenAI:</strong> Product images and data for
                  AI-powered description generation
                </li>
                <li>
                  <strong>Facebook/Meta:</strong> Ad creative content when you
                  create Facebook ads
                </li>
                <li>
                  <strong>Shopify:</strong> Product updates and store
                  integration
                </li>
                <li>
                ...
                <li>
                  <strong>Render:</strong> Application hosting and deployment
                </li>
              </ol>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                ...
                <li>
                  <strong>Secure Transmission:</strong> All data transmitted via
                  HTTPS/TLS
                </li>
                <li>
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                <li>
                  <strong>Active Data:</strong> Maintained while your account is
                  active
                </li>
                <li>
                  <strong>Product Descriptions:</strong> Retained for 90 days
                  after generation
                </li>
                <li>
                  <strong>Facebook Ad Drafts:</strong> Retained until manually
                  deleted or 1 year
                </li>
                <li>
                  <strong>OAuth Tokens:</strong> Refreshed regularly, expired
                  tokens deleted
                </li>
                <li>
                  <strong>Account Deletion:</strong> All data deleted within 30
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700">
                Contact us at privacy@thundertext.com or use the in-app settings
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                <li>
                  <strong>ads_management:</strong> Create and manage ads in your
                  Facebook campaigns
                </li>
                <li>
                  <strong>ads_read:</strong> Read your Facebook ad campaigns and
                  performance data
                </li>
                <li>
                  <strong>business_management:</strong> Access your Facebook
              ...
              <p className="text-gray-700 mb-3">
                You can revoke Thunder Text's access to your Facebook account at
                any time:
              </p>
              <ol className="list-decimal pl-6 text-gray-700 space-y-2">
                ...
                <li>
                  Alternatively, disconnect within Thunder Text app settings
                </li>
              </ol>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700">
                Thunder Text is not intended for users under 13 years of age. We
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700">
                ...
                than your own. We ensure adequate safeguards are in place for
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                <li>
                  <strong>Legal Basis:</strong> Processing based on consent and
                  contractual necessity
                </li>
                <li>
                  <strong>Data Protection Officer:</strong> dpo@thundertext.com
                </li>
                <li>
                  <strong>EU Representative:</strong> eu-rep@thundertext.com
                </li>
                <li>
                  <strong>Right to Lodge Complaint:</strong> Contact your local
            ...
            <section className="mb-8">
              ...
              <div className="text-gray-700 space-y-1">
                <p>
                  <strong>Email:</strong> privacy@thundertext.com
                </p>
                <p>
                  <strong>Support Portal:</strong>{" "}
                  <a
                    href="https://thunder-text.onrender.com/support"
                    className="text-blue-600 hover:text-blue-800 underline"
                  >
                    https://thunder-text.onrender.com/support
                  </a>
                </p>
                <p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700">
                ...
                (DPA), please contact enterprise@thundertext.com.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-3">
                We believe in transparency. This policy is written in plain
            ...
            <div className="border-t-2 border-gray-200 pt-6 mt-8">
              <p className="text-gray-700 text-center font-medium">
                <strong>Your trust is important to us.</strong> We are committed
