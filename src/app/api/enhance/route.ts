...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // const shop = formData.get('shop') as string  // Not used in this endpoint
    ...
    const existingDescription =
      (formData.get("existingDescription") as string) || "";
    const existingTitle = (formData.get("existingTitle") as string) || "";
    ...
    const formattedContent = {
      titleOptions: enhancementOptions.generateTitle
