...
export async function GET(request: NextRequest) {
  try {
    ...
    const { data: shopData, error: shopError } = await lookupShopWithFallback<{
      id: string;
      shop_domain: string;
    }>(supabase, shop, "id, shop_domain", "ad-drafts");
    ...
    if (draftsError) {
      logger.error("Error fetching ad drafts:", draftsError as Error, {
        component: "ad-drafts",
      });
      return NextResponse.json(
    ...
    logger.error("Error in GET /api/facebook/ad-drafts:", error as Error, {
      component: "ad-drafts",
    });
    return NextResponse.json(
      {
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (draftError) {
      logger.error("Error creating ad draft:", draftError as Error, {
        component: "ad-drafts",
      });
      return NextResponse.json(
    ...
    logger.error("Error in POST /api/facebook/ad-drafts:", error as Error, {
      component: "ad-drafts",
    });
    return NextResponse.json(
      {
