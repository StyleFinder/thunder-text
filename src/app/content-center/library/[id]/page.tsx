    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>Settings used to generate this content</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div>
              <p className="text-sm text-muted-foreground mb-1">Target Word Count</p>
              <p className="font-medium">{content.generation_params?.word_count || 'N/A'}</p>
            </div>
            <div>
              <p className="text-sm text-muted-foreground mb-1">Tone Intensity</p>
              <p className="font-medium">{content.generation_params?.tone_intensity || 'N/A'}/5</p>
            </div>
            <div>
              <p className="text-sm text-muted-foreground mb-1">CTA Type</p>
              <p className="font-medium capitalize">
                {content.generation_params?.cta_type?.replace('_', ' ') || 'None'}
              </p>
            </div>
            <div>
              <p className="text-sm text-muted-foreground mb-1">Content Type</p>
              <p className="font-medium">{CONTENT_TYPE_LABELS[content.content_type]}</p>
            </div>
          </div>
        </CardContent>
      </Card>
