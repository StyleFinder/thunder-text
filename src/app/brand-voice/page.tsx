...
export default function BrandVoicePage() {
  ...
  useEffect(() => {
    ...
    const initShop = async () => {
      ...
      try {
        ...
        logger.error('Failed to fetch shop:', e as Error, { component: 'brand-voice' });
      }
  ...
  const loadProfile = async () => {
    try {
      ...
      logger.error('Failed to load profile:', error as Error, { component: 'brand-voice' });
    } finally {
  ...
  const startInterview = async (mode: 'full' | 'quick_start' = 'full') => {
    ...
    try {
      ...
      logger.error('Failed to start interview:', error as Error, { component: 'brand-voice' });
  ...
  const submitAnswer = async () => {
    ...
    try {
      ...
      logger.error('Failed to submit answer:', error as Error, { component: 'brand-voice' });
  ...
  const generateProfile = async () => {
    ...
    try {
      ...
      logger.error('Failed to generate profile:', error as Error, { component: 'brand-voice' });
  ...
  const handleReset = async () => {
    ...
    try {
      ...
      logger.error('Failed to reset interview:', error as Error, { component: 'brand-voice' });
      ...
      <div className="w-full flex flex-col items-center" style={{ padding: '32px', background: '#fafaf9', minHeight: '100vh' }}>
        <div className="w-full" style={{ maxWidth: '1000px' }}>
          <div style={{ marginBottom: '32px' }}>
            <h1 style={{ fontSize: '32px', fontWeight: 700, marginBottom: '8px', color: '#003366', fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>Brand Voice</h1>
