      ...
      if (response.ok) {
        ...
        if (data.success && data.data.profile) {
          ...
          // If all questions answered but profile not yet generated, trigger generation
            ...
            addAIMessage(
              "All questions completed! Now generating your Business Profile...",
            );
  ...
  const startInterview = async (mode: "full" | "quick_start" = "full") => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setInterviewStatus("in_progress");
        setTotalQuestions(
          data.data.total_questions || (mode === "quick_start" ? 12 : 19),
        );

        const timeEstimate =
          mode === "quick_start" ? "8-10 minutes" : "15-20 minutes";
        addAIMessage(
          ...
          >
            <CardContent style={{ padding: "24px" }}>
              ...
              >
                ...
                >
                  Question {currentPrompt?.question_number || 0} of{" "}
                  {totalQuestions}
                </Badge>
                <Button
                  variant="outline"
