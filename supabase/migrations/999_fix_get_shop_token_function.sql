-- Fix get_shop_token function to use correct column names
-- This migration fixes the column references from access_token/scope to shopify_access_token/shopify_scopes
