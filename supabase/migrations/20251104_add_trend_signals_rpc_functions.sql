-- RPC functions for trend_signals and trend_series with SECURITY DEFINER
-- to bypass PostgREST permission layer (matching pattern from themes)
...
BEGIN
  ...
  ON CONFLICT (shop_id, theme_id, granularity)
  DO UPDATE SET
